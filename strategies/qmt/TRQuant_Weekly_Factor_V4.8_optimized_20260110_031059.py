#coding:gbk
# TRQuant Weekly Factor Strategy V4.7
# Created: 2026-01-10 01:49:02
# Updated: 2026-01-10 02:48:00
# Version History:
...
def handlebar(ContextInfo):
    ...
    try:
        current_prices = get_all_stock_data(ContextInfo, target_stocks, 'open', 1, use_disk_cache=USE_DISK_CACHE)
        if not current_prices or len(current_prices) == 0:
            ...
            return
        print(f"[Data] Retrieved open prices for {len(current_prices)}/{len(target_stocks)} target stocks")
    except Exception as e:
