#coding:gbk
# TRQuant Weekly Factor Strategy V4.6
# Created: 2026-01-10 01:49:02
# Updated: 2026-01-10 02:37:12
# Version History:
...
def init(ContextInfo):
    """Initialize strategy"""
    print("=" * 70)
    print(f"TRQuant Weekly Factor Strategy V4.6 (Mode: {STRATEGY_MODE})")
    print(f"[Init] Version: V4.6 - Added passorder support, QMT examples in KB")
    print("=" * 70)
...
def handlebar(ContextInfo):
    ...
    try:
        current_prices = get_all_stock_data(ContextInfo, target_stocks, 'open', 1)
