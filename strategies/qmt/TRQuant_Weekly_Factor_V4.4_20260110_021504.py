...
#     - Fixed QMT warning: [ϵͳ][WARNING][set_universe]��Ч��Ʊ����
#   V4.0 (2026-01-10):
...
COMMISSION_RATE = 0.0001     # 0.01% commission (���֮һ)
...
def calculate_stock_factors(ContextInfo, stock, close_22, high_22, low_22, volume_22, fundamental_data=None):
    ...
    try:
        ...
        # Aligned with BulletTrade: Get from valuation.market_cap (��λ����Ԫ)
...
def calculate_factor_score(factors):
    ...
    # 3. Market cap: 30~200�����ţ�����ֵ115�� (aligned with BulletTrade)
    ...
    # 6. ROE: >0���ţ����10%ROE������ (aligned with BulletTrade)
    ...
    # 7. Growth: >0���ţ����100%���������� (aligned with BulletTrade)
