...
def get_all_stock_data(ContextInfo, stocks, field, days, use_disk_cache=True):
    ...
    try:
        # Get current date for cache key (to handle different backtest periods)
        ...
        if use_disk_cache:
            disk_data = _load_from_disk_cache(field, days, current_date_str)
        ...
        if use_disk_cache:
            _save_to_disk_cache(field, days, result, current_date_str)
