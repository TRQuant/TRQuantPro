...
# Note: 5%~30% is optimal range, but we use 0% as minimum to allow stocks in weak markets
# The scoring system will penalize low momentum stocks, but won't exclude them completely
MIN_MOMENTUM_20D = 0.0       # Min 20-day momentum (%) - Relaxed from 5.0% to allow weak markets
...
def init(ContextInfo):
    """Initialize strategy"""
    print("=" * 70)
    print(f"TRQuant Weekly Factor Strategy V4.7 (Mode: {STRATEGY_MODE})")
    print(f"[Init] Version: V4.7 - Fixed cache bug (barpos in key), added return calculation")
