#coding:gbk
# TRQuant Weekly Factor Strategy V4.3
# Created: 2026-01-10 01:49:02
# Version History:
#   V4.3 (2026-01-10 01:49:02):
#     - Fixed data loading issue for large universe (5404 stocks)
#     - Added error handling and progress logging for data retrieval
#     - Added try-catch around get_history_data to prevent silent failures
#     - Enhanced logging to diagnose why handlebar may not execute
...
def init(ContextInfo):
    """Initialize strategy"""
    print("=" * 70)
    print(f"TRQuant Weekly Factor Strategy V4.3 (Mode: {STRATEGY_MODE})")
    print("=" * 70)
