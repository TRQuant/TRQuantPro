...
class ReportGenerator:
    ...
    def generate_report(
        self, backtest_result: Dict, output_path: str = None, strategy_name: str = "多因子选股策略"
    ) -> str:
        """
        生成回测报告PDF
            ...
            TableStyle(
                [
                    ...
                    (
                        ...
                        (0, 0),
                        (-1, -1),
                        "ChineseFont" if REPORTLAB_AVAILABLE else "Helvetica",
                    ),
                    ("FONTSIZE", (0, 0), (-1, -1), 10),
    ...
    def _create_monthly_returns(self, result: Dict) -> List:
        ...
        # 如果有月度数据则显示，否则显示提示
        elements.append(
            Paragraph("（详细月度收益数据请参阅回测系统的图表展示）", self.styles["ChineseBody"])
        )
...
def generate_backtest_report(
    result: Dict, output_path: str = None, strategy_name: str = "多因子选股策略"
) -> str:
    """
    生成回测报告
