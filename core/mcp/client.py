...
class MCPClient:
    ...
    TOOL_SERVER_MAP = {
        ...
        "workflow9.list": "workflow_9steps_server",
        "workflow9.restore": "workflow_9steps_server",
        "workflow9.delete": "workflow_9steps_server",
        
        # trquant_core_server (十倍股和其他核心工具)
        "tenbagger.evaluate": "trquant_core_server",
        "tenbagger.scan": "trquant_core_server",
        "tenbagger.rank": "trquant_core_server",
        "tenbagger.scorecard": "trquant_core_server",
        "tenbagger.filter": "trquant_core_server",
        "tenbagger.report": "trquant_core_server",
        "tenbagger.history": "trquant_core_server",
        "tenbagger.batch": "trquant_core_server",
        "tenbagger.stats": "trquant_core_server",
        "market.status": "trquant_core_server",
        "market.trend": "trquant_core_server",
        "market.mainlines": "trquant_core_server",
        "market.analyze_trend": "trquant_core_server",
        "data.get_price": "trquant_core_server",
        "data.get_index_stocks": "trquant_core_server",
        ...
        # 进度和风险
        "progress.summary": "project_manager_server",
        "progress.daily_report": "project_manager_server",
        "risk.add": "project_manager_server",
        "risk.assess": "project_manager_server",
        "report.visualize": "report-server",
        "report.archive": "report-server",
        "report.list": "report-server",
        # unified_dev_server (统一开发工具 - 33个)
        "task.create": "unified_dev_server",
        "task.list": "unified_dev_server",
        "task.get": "unified_dev_server",
        "task.update": "unified_dev_server",
        "task.complete": "unified_dev_server",
        "task.add_note": "unified_dev_server",
        "task.analyze": "unified_dev_server",
        "task.recommend_mode": "unified_dev_server",
        "task.cache_context": "unified_dev_server",
        "devlog.add": "unified_dev_server",
        "devlog.list": "unified_dev_server",
        "milestone.create": "unified_dev_server",
        "milestone.list": "unified_dev_server",
        "milestone.progress": "unified_dev_server",
        "issue.create": "unified_dev_server",
        "issue.list": "unified_dev_server",
        "issue.resolve": "unified_dev_server",
        "experience.add": "unified_dev_server",
        "experience.search": "unified_dev_server",
        "experience.mark_useful": "unified_dev_server",
        "progress.summary": "unified_dev_server",
        "progress.daily_report": "unified_dev_server",
        "risk.add": "unified_dev_server",
        "risk.assess": "unified_dev_server",
        "registry.register": "unified_dev_server",
        "registry.list": "unified_dev_server",
        "registry.status": "unified_dev_server",
        "registry.snapshot": "unified_dev_server",
        "debug.log": "unified_dev_server",
        "debug.trace": "unified_dev_server",
        "debug.status": "unified_dev_server",
        "workflow.batch": "unified_dev_server",
        "workflow.check": "unified_dev_server",
        "code.analyze": "unified_dev_server",
        "code.lint": "unified_dev_server",
        "code.convert": "unified_dev_server",
        "lint.check": "unified_dev_server",
        "lint.fix": "unified_dev_server",
        "lint.rules": "unified_dev_server",
        "spec.list": "unified_dev_server",
        "spec.get": "unified_dev_server",
        "spec.check": "unified_dev_server",
        "eng.test": "unified_dev_server",
        "eng.build": "unified_dev_server",
        "eng.deploy": "unified_dev_server",
        "docs.list": "unified_dev_server",
        "docs.get": "unified_dev_server",
        "docs.search": "unified_dev_server",
        "schema.list": "unified_dev_server",
        "schema.get": "unified_dev_server",
        "schema.validate": "unified_dev_server",
        "secrets.list": "unified_dev_server",
        "secrets.get": "unified_dev_server",
        "secrets.set": "unified_dev_server",
    ...
    def _find_python_path(self) -> str:
        ...
        if trquant_root:
            trquant_venv = Path(trquant_root) / "venv"
            if platform.system() == "Windows":
    ...
    def _run_async_in_thread(self, coro_func, *args, **kwargs):
        """在线程中运行异步函数"""
        import asyncio
        loop = asyncio.new_event_loop()
        asyncio.set_event_loop(loop)
...
# 添加GUI工具映射到TOOL_SERVER_MAP
MCPClient.TOOL_SERVER_MAP.update({
    # GUI工具
    "gui.status": "unified_dev_server",
    "gui.validate": "unified_dev_server",
    "gui.generate_html": "unified_dev_server",
    "gui.check_csp": "unified_dev_server",
    # Webview工具
    "webview.create_message": "unified_dev_server",
    "webview.validate_message": "unified_dev_server",
    "webview.generate_script": "unified_dev_server",
    # Panel工具
    "panel.list": "unified_dev_server",
    "panel.get_config": "unified_dev_server",
    "panel.validate": "unified_dev_server",
})

# 添加会话和快捷工具映射
MCPClient.TOOL_SERVER_MAP.update({
    # 会话工具
    "session.init": "unified_dev_server",
    "session.summary": "unified_dev_server",
    "session.checklist": "unified_dev_server",
    # 快捷工具
    "quick.start_task": "unified_dev_server",
    "quick.finish_task": "unified_dev_server",
    "quick.log": "unified_dev_server",
    "quick.issue": "unified_dev_server",
})

        # 添加知识库和自学习工具映射
MCPClient.TOOL_SERVER_MAP.update({
    # 知识库工具
    "knowledge.add": "unified_dev_server",
    "knowledge.search": "unified_dev_server",
    "knowledge.get": "unified_dev_server",
    "knowledge.update": "unified_dev_server",
    "knowledge.mark_useful": "unified_dev_server",
    "knowledge.stats": "unified_dev_server",
    # 错误模式库
    "error_pattern.add": "unified_dev_server",
    "error_pattern.search": "unified_dev_server",
    "error_pattern.list": "unified_dev_server",
    # 最佳实践库
    "practice.add": "unified_dev_server",
    "practice.search": "unified_dev_server",
    "practice.list": "unified_dev_server",
    # 自学习系统
    "learn.from_issue": "unified_dev_server",
...
MCPClient.TOOL_SERVER_MAP.update({
    # 数据源服务器 v2
    "data_source.health_check": "data_source_server_v2",
    "data_source.status": "data_source_server_v2",
    "data_source.switch": "data_source_server_v2",
    "data_source.get_price": "data_source_server_v2",
    "data_source.get_index_stocks": "data_source_server_v2",
    "data_source.get_realtime": "data_source_server_v2",
