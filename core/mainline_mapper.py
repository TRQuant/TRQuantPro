...
class MainlineMapper:
    ...
    def map_mainline(
        self, akshare_name: str, prefer_type: str = "concept"  # 'concept' 或 'industry' 或 'auto'
    ...
    def map_multiple_mainlines(
        self, akshare_names: List[str], prefer_type: str = "auto"
    ...
    def _find_match(
        self, akshare_name: str, jqdata_dict: Dict[str, str], mapping_type: str
    ) -> Optional[MainlineMapping]:
        """
        查找匹配
    ...
    def get_recommended_features(
        self, mapping: MainlineMapping, period: str = "medium"
    ) -> Dict[str, any]:
        """
        获取推荐的特征条件
