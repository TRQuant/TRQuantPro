        ...
        try:
            ...
            if result:
                ...
                db.sector_rotation.update_one(
                    {"date": result.analysis_date[:10]}, {"$set": doc}, upsert=True
                )
    ...
    def _update_north_capital(self):
        ...
        try:
            ...
            if result:
                ...
                db.capital_flow.update_one({"date": doc["date"]}, {"$set": doc}, upsert=True)
    ...
    def _update_trend_analysis(self):
        ...
        try:
            ...
            if result:
                ...
                db.trend_analysis.update_one({"date": doc["date"]}, {"$set": doc}, upsert=True)
            ...
            try:
                ...
                if df is not None and not df.empty:
                    for _, row in df.iterrows():
                        ...
                        db.stock_info.update_one({"code": doc["code"]}, {"$set": doc}, upsert=True)
