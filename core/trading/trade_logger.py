...
class TradeLogger:
    ...
    def __init__(self, account_id: str = "default", mongodb_uri: str = "mongodb://localhost:27017"):
        """
        初始化
        ...
        if MONGO_AVAILABLE:
            try:
                ...
                self.collection.create_index(
                    [("timestamp", -1), ("log_type", 1), ("account_id", 1)]
                )
    ...
    def log_signal(
        ...
        **extra,
        ...
        log = TradeLog(
            ...
            direction=direction,
            message=message,
            extra_data={"signal_type": signal_type, "score": score, **extra},
        )
    ...
    def log_error(self, message: str, stock_code: str = "", order_id: str = "", **extra) -> str:
        """
        记录错误
    ...
    def export_logs(
        self, filepath: str, log_type: str = None, start_date: str = None, end_date: str = None
    ):
        """导出日志到文件"""
        logs = self.query_logs(
            log_type=log_type, start_date=start_date, end_date=end_date, limit=10000
        )
