...
`StockPool`是股票池的容器，包含多个`StockPoolItem`：
...
<h2 id="section-5-1-2">📦 5.1.2 股票池创建</h2>

股票池创建支持多种类型的股票池，包括基础股票池、自定义股票池和动态股票池。

### 基础股票池

基础股票池包括全市场股票池、行业股票池等：
...
<h2 id="section-5-1-3">🔄 5.1.3 三层数据保障架构</h2>

三层数据保障架构确保股票池构建的可靠性，即使主数据源失败也能提供备选方案。
...
<h2 id="section-5-1-4">🔀 5.1.4 股票池合并与去重</h2>

股票池合并支持多来源合并，自动去重，并进行交叉验证和优先级调整。
...
<h2 id="section-5-1-5">🔄 5.1.5 股票池更新与维护</h2>

股票池支持定时更新、事件触发更新和增量更新。
