...
<!-- 原始代码（保留作为备份）：
```
-->1_02.py<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_03.py<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_03.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 其他字段同日线数据
```
-->en, high, low, close, volume, amount
# time: datetime类型，索引列
# 其他字段同日线数据
```
-->en, high, low, c<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_02.py"
  language="python"
  showDesignPrin<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_02.py"
  language="python"
  showDesignPrinciples="true"
/>
...
<!-- 原始代码（保留作为备份）：
```
-->Chapter2_Data_Source/2.1/code_2_1_03.py"
  language="python"
  showDesignPrinciples="true"
/>
...
class AKShareSource(BaseDataSource):
    ...
    def __init__(self):
       <CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_08.py"
  language="python"
  showDesignPrinciples="true"
/>
...
<!-- 原始代码（保留作为备份）：
```
--> str, fields: List[str] = None) -> pd.DataFrame:
        """获取日线数据"""
        if not self._connected:
            raise ConnectionError("JQData未连接")
...
def _failover_fetch(self, symbol: str, start_date: str, end_date: str,
  ...
  filePath="code_library/002_Chapter2_Data_Source/2.1/002_Chapter2_Data_Source/2.1/code_2_1_get_<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1__failover_fetch.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def _failover_fetch(self, symbol: str, start_date: str, end_date: str,
    ...
    # 3. 记录故障
    logger.warning(f"数据源 {failed_source} 故障，尝试备用数据源: {candidates}")
    self._record_failure(failed_source, symbol, data_type)<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1__failover_fetch.py"
  language="python"
  showDesignPrinciples="true"
/>
...
<!-- 原始代码（保留作为备份）：
```
-->源 {failed_source} 故障，尝试备用数据源: {candidates}")
    self._record_failure(failed_source, symbol, data_type)
...
def _failover_fetch(self, symbol: str, start_date: str, end_date: str,
    ...
    # 1. 获取备用数据源列表
    candidates = self.priority.get(<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Sourc<CodeFromFile 
...
def store_market_data_to_timeseries(symbol: str, data: pd.DataFrame, 
    ...
    # 批量插入
    ts_db.insert_batc<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_save_data_source_config.py"
  language="python"
  showDesignPrinciples="true"
/>
...
<!-- 原始代码（保留作为备份）：
```python
def get_data_with_cac<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_12.py"
  language="python"
  showDesignPrinciples="true"
/>
...
```
-->ter2_Data_Source/2.1/code_2_1_get_data_with_cache.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def get_data_with_cache(symbol: str, start_date: str, end_date: str, 
    ...
    if self.cache:
        self.cache.set(cache_key, data, ttl=3600)
    <CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_18.py"
  language="python"
  showDesignPrinciples="true"
/>
...
<!-- 原始代码（保留作为备份）：
```
-->Data_Source/2.1/code_2_1_16.py"
  language="python"
  showDesignPrinciples="true"
/>
...
data_collector.collect_academic(
    database="arxiv",
    query="<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_15.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def get_data_with_cache(symbol: str, start_date: str, end_date: str, 
    ...
    if self.cache:
        self.cache.set(cache_key, data, ttl=3600)
    <CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/code_2_1_17.py"
  language="python"
  showDesignPrinciples="true"
/>
...
> **适用版本**: v1.0.0+  
> **最后更新**: 2025-12-12
<!-- Code updated: 2025-12-14T01:37:10.410Z -->
