...
class DataSourceManager:
    ...
    def check_all_sources(self) -> Dict[str, Dict[str, Any]]:
        """检查所有数据源状态"""
   <CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/002_Chapter2_Data_Source/2.1/code_2_1_02.py"
  language="python"
  showDesignPrinciples="true"
/>
...
-->           "checked_at": datetime.now().isoformat()
    ...
    def get_daily_data(self, symbol: str, start_date: str, 
                       end_date: str, fields: List[str] = None) -> pd.DataFrame:
        """获取日线数据"""
        # AKShare的股票代码格式：0<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/002_Chapter2_Data_Source/2.1/code_2_1_select_source.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def health_check_all(self, interval: int = 300):
    ...
    thread.start()
```
-->ontinue<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/002_Chapter2_Data_Source/2.1/code_2_1__failover_fetch.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def get_data_with_load_balance(self, symbol: str, start_date: str, 
    ...
    for source_name, _ in available_sources:
        try:
            ...
            logger.warning(f"数据源 {sourc<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/002_Chapter2_Data_Source/2.1/code_2_1_save_data_source_config.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def store_market_data_to_timeseries(symbol: str, data: pd.DataFrame, 
    ...
    for date, row in data.iterrows():
        records.append({
            ...
            "amo<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/002_Chapter2_Data_Source/2.1/code_2_1_get_data_with_cache.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def get_data_with_cache(symbol: str, start_date: str, end_date: str, 
    ...
    if self.cache:
        self.cache.set(ca<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/002_Chapter2_Data_Source/2.1/code_2_1_14.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 查询数据源管理相关文档
results = kb.query(
    query="数据源管理接口设计 BaseDat<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.1/002_Chapter2_Data_Source/2.1/code_2_1_15.py"
  language="python"
  showDesignPrinciples="true"
/>
...
> **适用版本**: v1.0.0+  
> **最后更新**: 2025-12-12
<!-- Code updated: 2025-12-14T01:30:12.296Z -->
