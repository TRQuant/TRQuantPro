...
-- <CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.3/002_Chapter2_Data_Source/2.3/code_2_3_store_market_data.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def cache_batch_snapshots(snapshots: dict, ttl: int = 60):
   <CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.3/002_Chapter2_Data_Source/2.3/code_2_3_enqueue_data_update_task.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def get_source_health(source_name: str) -> dict:
    ...
    if data:
        return json.loads(data)
    re<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.3/002_Chapter2_Data_Source/2.3/code_2_3_save_to_parquet.py"
  language="python"
  showDesignPrinciples="true"
/>
...
CACHE_DIR = Path("data/cache/parquet")
<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.3/002_Chapter2_Data_Source/2.3/code_2_3___init__.py"
  language="python"
  showDesignPrinciples="true"
/>
