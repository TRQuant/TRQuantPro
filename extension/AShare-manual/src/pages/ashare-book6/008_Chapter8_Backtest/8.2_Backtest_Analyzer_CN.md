...
<CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.2/code_8_2_从BulletTrade结果提取数据.py"
  language="python"
...
class ReturnAnalyzer:
    ...
    def _calculate_annual_return(
        ...
        """计算年化收益率"""
       <CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.2/code_8_2_使用示例.py"
  language="python"
  showDesignPrinciples="true"
/>
...
print(f"<CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.2/code_8_2_从BulletTrade结果提取交易记录.py"
  language="python"
  showDesignPrinciples="true"
/>
