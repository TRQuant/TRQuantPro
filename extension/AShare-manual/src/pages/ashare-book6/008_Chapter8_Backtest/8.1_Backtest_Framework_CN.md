...
<CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.1/code_8_1_初始化BulletTrade引擎.py"
  language="python"
...
- **参数设计**：
  ...
  <CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.1/code_8_1_执行回测.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 生成HTML报告
report_path = engine.generate_report(result, output_dir="backtest_results")
print(f"回测报告已生成: {report<CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.1/code_8_1_PTrade平台部署.py"
  language="python"
  showDesignPrinciples="true"
/>
...
backtest_result = deployer.run_backtest(
    ...
    start_date="2023-01-01",
<CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.1/code_8_1_QMT平台部署.py"
  language="python"
  showDesignPrinciples="true"
/>
...
class BacktestConfig:
    ...
    def validate(self) -> Tuple[bool, List[str]]:
        ...
        <CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.1/code_8_1_聚宽数据源集成.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def run_complete_backtest_workflow(
    ...
    if deploy_to_qmt:
        ...
        try:
         ...
         <CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.1/code_8_1_使用示例.py"
  language="python"
  showDesignPrinciples="true"
/>
