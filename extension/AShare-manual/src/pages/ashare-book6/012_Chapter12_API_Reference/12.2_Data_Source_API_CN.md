...
<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_初始化数据源.py"
  language="python"
...
# 创<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_查询数据源状态.py"
  language="python"
  showDesignPrinciples="true"
/>
...
if jq_status:
  ...
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_获取可用日期范围.py"
  language="python"
  showDesignPrinciples="true"
/>
...
jq_start, jq_end = ds_manager.get_available_date_r<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_获取价格数据.py"
  language="python"
  showDesignPrinciples="true"
/>
...
result = ds_manager.get_price(
  ...
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_指定数据源.py"
  language="python"
  showDesignPrinciples="true"
/>
...
-->数据形状: {data.shape}")
    ...
    p<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_数据类型.py"
  language="python"
  showDesignPrinciples="true"
/>
...
if result.succ<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_获取基本面数据.py"
  language="python"
  showDesignPrinciples="true"
/>
...
### 获取基<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_注意事项.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 设计原理：缓存命中时，直接从MongoDB读取<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_数据更新.py"
  language="python"
  showDesignPrinciples="true"
/>
...
ds_manager<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_缓存管理.py"
  language="python"
  showDesignPrinciples="true"
/>
