...
<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_init_data_source.py"
  language="python"
...
# 创<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_query_data_source_status.py"
  language="python"
  showDesignPrinciples="true"
/>
...
if jq_status:
    ...
    print(f"日期范围: {jq_status<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_get_available_date_range.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 获取指定数据源的日期范围
jq_start, jq_end = ds_manager.get_available_date_r<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_get_price_data.py"
  language="python"
  showDesignPrinciples="true"
/>
...
result = ds_manager.get_price(
    ...
    frequency="daily",  #<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_specify_data_source.py"
  language="python"
  showDesignPrinciples="true"
/>
...
-->数据形状: {data.shape}")
    ...
    p<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_data_type.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 检查结果
if result.succ<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_get_fundamental_data.py"
  language="python"
  showDesignPrinciples="true"
/>
...
### 获取基<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_notes.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 再次获取相同数据（从缓存获取，速度更快）
# 设计原理：缓存命中时，直接从MongoDB读取<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_data_update.py"
  language="python"
  showDesignPrinciples="true"
/>
...
```python
# 更新指定股票的数据
ds_manager<CodeFromFile 
  filePath="code_library/012_Chapter12_API_Reference/12.2/code_12_2_cache_management.py"
  language="python"
  showDesignPrinciples="true"
/>
