...
<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_00.py"
  language="python"
...
MCP_TOOLS = [
    ...
    "trquant_recomme<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_01.py"
  language="python"
  showDesignPrinciples="true"
/>
...
```python
# 知识库MC<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_02.py"
  language="python"
  showDesignPrinciples="true"
/>
...
实现数据收集能力，让AI可以深入研究<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_03.py"
  language="python"
  showDesignPrinciples=<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_04.py"
  language="python"
  showDesignPrinciples="true"
/>
...
bm2<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_05.py"
  language="python"
  showDesignPrinciples="true"
/>
...
```python
# 向量检索 + BM25检索
vector_results = vector_<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_06.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 阶段2：规则判断
market_status = judge_market_s<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_07.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 阶段3：<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_08.py"
  language="python"
  showDesignPrinciples="true"
/>
...
strategy_code = ai_assistant.generate_strategy(
    fac<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/code_1_4_09.py"
  language="python"
  showDesignPrinciples="true"
/>
...
*最后更新: 2025-12-12*  
*适用版本: v1.0.0+*
<!-- Code updated: 2025-12-14T01:18:16.403Z -->
