...
<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_00.py"
  language="python"
...
MCP_TOOLS = [
    ...
    "trquant_mainlines",  <CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_01.py"
  language="python"
  showDesignPrinciples="true"
/>

<!-<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_02.py"
  language="python"
  showDesignPrinciples="true"
/>
...
```
-->   "kb.<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_03.py"
  language<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_04.py"
  language="python"
  showDesignPrinciples="true"
/>
...
```python
# 向量检索 + BM25检索
vector_results = vec<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_05.py"
  language="python"
  showDesignPrinciples="true"
/>
...
**阶段1：基础向量检索**<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_06.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 阶段2：规则<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_07.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 阶段2：规则推荐
factors = recommend_factor<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_08.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 阶段3：AI智能生成
strategy_code = ai_ass<CodeFromFile 
  filePath="code_library/001_Chapter1_System_Overview/1.4/001_Chapter1_Market_Analysis/1.4/code_1_4_09.py"
  language="python"
  showDesignPrinciples="true"
/>
...
*最后更新: 2025-12-12*  
*适用版本: v1.0.0+*
<!-- Code updated: 2025-12-14T01:17:29.256Z -->
