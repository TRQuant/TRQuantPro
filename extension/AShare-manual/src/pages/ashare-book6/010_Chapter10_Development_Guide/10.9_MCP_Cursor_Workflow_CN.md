...
<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.9/code_10_9_FactorManager.py"
  language="python"
...
spec_ser<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.9/code_10_9_使用示例.py"
  language="python"
  showDesignPrinciples="true"
/>
...
with open("docs/strategy_guide.md", "r") as f:
  ...
  filePath="code_library/010_Chapter10_Development_Guide/10.9/code_10_9_安全写入流程.py"
  language="python"
  showDesignPrinciples="true"
/>
...
git.tag(f"factor-momentum_20d-v{factor_result['version']<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.9/code_10_9_步骤.py"
  language="python"
  showDesignPrinciples="true"
/>
