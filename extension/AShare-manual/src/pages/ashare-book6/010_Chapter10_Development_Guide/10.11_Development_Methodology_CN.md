...
<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.11/code_10_11_示例.py"
  language="python"
...
-->     }
    ...
    response = github_api.create_gist(gist_data)
    gist_i<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.11/code_10_11_核心工具.py"
  language="python"
  showDesignPrinciples="true"
/>
...
tools = [
    ...
    },
    {
        ...
        "description": "分析网络请求",
        <CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.11/code_10_11_使用场景.py"
  language="python"
  showDesignPrinciples="true"
/>
