...
<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7___init__.py"
  language="python"
...
class MCPServer:
    ...
    def list_tools(self) -> List[Dict]:
        """列出所有可用工<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_tool.py"
  language="python"
  showDesignPrinciples="true"
/>
    ...
    "inputSchema": {
        ...
        "properties": {
            "universe": {
                "type": "string",
               <CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_resource.py"
  language="python"
  showDesignPrinciples="true"
/>
    ...
    async def call_tool(self, name: str, arguments: dict) -> dict:
        ...
        try:
            ...
            return {
                "content": [{
                    "type": "text",
                    "text": json.dumps(result, ensure_ascii=False<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7___init__.py"
  language="python"
  showDesignPrinciples="true"
/>
...
--> if not query:
          ...
          <CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_tool_definition.py"
  language="python"
  showDesignPrinciples="true"
/>
        ...
        input_schema={
            ...
            "properties": {
                ...
                "max_position": {
                    "type": "number",
                    "des<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7__get_market_status.py"
  language="python"
  showDesignPrinciples="true"
/>
...
async def _generate_strategy(self, args: dict) -> dict:
    ...
    result = generator.generate(
        ...
        risk_params={
            'max_position': args.get('ma<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_call_tool.py"
  language="python"
  showDesignPrinciples="true"
/>
...
async def call_tool(self, name: str, arguments: dict) -> dict:
    ...
    try:
        ...
        return {
            "isError": True<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_resource_definition.py"
  language="python"
  showDesignPrinciples="true"
/>
...
resources = [
    ...
    {<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_get_resource.py"
  language="python"
  showDesignPrinciples="true"
/>
...
async def get_resource(self, uri: str) -> dict:
    ...
    if uri.startswith("file://"):
        ...
        return {
            "isError": True,
        <CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_prompt_definition.py"
  language="python"
  showDesignPrinciples="true"
/>
...
prompts = [
    ...
    },
    {
        ...
        "arguments": [
            ...
            {<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_get_prompt.py"
  language="python"
  showDesignPrinciples="true"
/>
...
<!-- 原始代码（保留作为备份）：
```python
async def get_prompt(self, nam<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_test_tool.py"
  language="python"
  showDesignPrinciples="true"
/>
...
async def get_prompt(self, name: str, arguments: dict) -> dict:
    ...
    prompt_templates = {
        ...
        市场范围：{universe}
        """,
        "generate_strat<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_handle_request.py"
  language="python"
  showDesignPrinciples="true"
/>
...
async def handle_request(request: dict, server: MCPServer) -> dict:
    ...
    if method == "initialize":
        ...
        return {
            "js<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.7/code_10_7_main.py"
  language="python"
  showDesignPrinciples="true"
/>
