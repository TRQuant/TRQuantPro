...
<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_vector_database.py"
  language="python"
...
embeddings = HuggingFaceEmbeddings(
    ...
    model_kwargs={'device': '<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_keyword_search.py"
  language="python"
  showDesignPrinciples="true"
/>
...
bm25 = B<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_rerank.py"
  language="python"
  showDesignPrinciples="true"
/>
...
<h2 id="section-10-10-2">🏗️ 10.10.2 知识库<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_collect_manual_kb_files.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def collect_manual_kb_files() -> List[Path]:
    ...
    files.extend(docs_<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_chunk_markdown.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def chunk_markdown(file_path: Path) -> List[Document]:
    ...
    all_chunks = []
    for<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_extract_symbols.py"
  language="python"
  showDesignPrinciples="true"
/>
...
-->a={
                        "typ<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_build_manual_kb_index.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def build_manual_kb_index():
    ...
    with open("data/kb/manual_kb/documents.json", 'w', encoding='utf-8') as f:
        js<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_extract_metadata.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def extract_metadata(file_path: Path) -> Dict[str, Any]:
    ...
    if "Chapter" in str(rel_path):
        ...
        if chapter_match:
   <CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10___init__.py"
  language="python"
  showDesignPrinciples="true"
/>
...
class KBServer:
    ...
    def _rerank_results(
        ...
        r<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_index_optimization.py"
  language="python"
  showDesignPrinciples="true"
/>
...
# 使用更快的embedding模型
embeddings = H<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_cached_query.py"
  language="python"
  showDesignPrinciples="true"
/>
...
async def async_query(query: str, scope: str, top_k: int):
  ...
  <CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_storage_optimization.py"
  language="python"
  showDesignPrinciples="true"
/>
