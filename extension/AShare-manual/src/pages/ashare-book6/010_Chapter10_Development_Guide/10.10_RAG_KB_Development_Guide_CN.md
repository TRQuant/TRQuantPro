...
<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_向量数据库.py"
  language="python"
...
embeddings = HuggingFaceEmbeddings(
  ...
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_关键词检索.py"
  language="python"
  showDesignPrinciples="true"
/>
...
bm25 = B<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_重排序.py"
  language="python"
  showDesignPrinciples="true"
/>
...
class KBServer:
    ...
    def _rerank_results(
        ...
        r<CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_索引优化.py"
  language="python"
  showDesignPrinciples="true"
/>
...
async def async_query(query: str, scope: str, top_k: int):
  ...
  <CodeFromFile 
  filePath="code_library/010_Chapter10_Development_Guide/10.10/code_10_10_存储优化.py"
  language="python"
  showDesignPrinciples="true"
/>
