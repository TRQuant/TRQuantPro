...
<CodeFromFile 
  filePath="code_library/011_Chapter11_User_Manual/11.1/code_11_1_配置JQData.py"
  language="python"
...
# 在GUI中配置
1. <CodeFromFile 
  filePath="code_library/011_Chapter11_User_Manual/11.1/code_11_1_配置AKShare.py"
  language="p<CodeFromFile 
  filePath="code_library/011_Chapter11_User_Manual/11.1/code_11_1_执行市场分析.py"
  language="python"
  showDesignPrinciples="true"
/>
...
4. 查看分析结果：
   ...
   - 指数趋势
   - 风格<CodeFromFile 
  filePath="code_library/011_Chapter11_User_Manual/11.1/code_11_1_使用策略生成器.py"
  language="python"
  showDesignPrinciples="true"
/>
...
3. 选择策略风格：
  ...
  filePath="code_library/011_Chapter11_User_Manual/11.1/code_11_1_执行策略回测.py"
  language="python"
  showDesignPrinciples="true"
/>
