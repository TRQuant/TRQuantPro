...
<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.4/code_6_4___init__.py"
  language="python"
...
class FactorPipeline:
    ...
    def __init__(
        ...
        self.run_stats = {
            ...
            "total_stocks": 0,
            "success_factors": 0,
            "failed_f<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.4/code_6_4_get_stock_pool.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def get_stock_pool(self, date: Union[str, datetime]) -> List[str]:
    ...
    if self.stock_pool == "hs300":
        ...
        return jq.get_index_stocks<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.4/code_6_4_filter_stocks.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def filter_stocks(self, stocks: List[str], date: Union[str, datetime]) -> List[str]:
 ...
 <CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.4/code_6_4_run_pipeline.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def run_pipeline(
    ...
    try:
        ...
        self.run_stats["end_time<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.4/code_6_4_save_factor_values.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def save_factor_values(
    ...
    try:
        ...
        if success:
            ...
            logger.warning(f"因子值保存失败: {factor_name} @ {dat<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.4/code_6_4__check_data_quality.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def _check_data_quality(self, stocks: List[str], date: datetime) -> bool:
    ...
    try:
        ...
        retur<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.4/code_6_4_start_daily_pipeline.py"
  language="python"
  showDesignPrinciples="true"
/>
