...
<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.5/code_6_5_to_dict.py"
  language="python"
...
class FactorPoolIntegration:
    ...
    def __init__(
        ...
        # 权重配置
        s<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.5/code_6_5_calculate_factor_score.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def calculate_factor_score(
   ...
   <CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.5/code_6_5_process_candidate_pool.py"
  language="python"
  showDesignPrinciples="true"
/>
...
```
综合评分 = 因子评分 × 因子权重 + 主线评分<CodeFromFile 
  filePath="code_library/006_Chapter6_Factor_Library/6.5/code_6_5_kb.py"
  language="python"
  showDesignPrinciples="true"
/>
...
> **适用版本**: v1.0.0+  
> **最后更新**: 2025-12-12
<!-- Code updated: 2025-12-14T02:17:27.809Z -->
