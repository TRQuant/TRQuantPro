...
<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_dimension_config.py"
  language="python"
...
| policy_strength | 0.35 | 政策文件分<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_calculate_policy_score.py"
  language="python"
  showDesignPrinciples="true"
/>
...
| 因子名称 | 权重 | 数据来源 | 计算方法 | 阈值（高/中/低） |
|---------|------|---------|---------|---<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_normalize_factor_value.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def normalize_factor_value(
  ...
  <CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_calculate_factor_score.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def calculate_factor_score(
    ...
    return FactorScore(
        ...
        data_source=factor_config["<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_calculate_dimension_score.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def calculate_dimension_score(
    ...
    return DimensionScore(
        ...
        total_score=total_score,
 <CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1___init__.py"
  language="python"
  showDesignPrinciples="true"
/>
...
class ScoringModel:
    ...
    def calculate_mainline_score(
        ...
        return MainlineScore(
            ...
            risk_warning=risk_wa<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_get_score_level.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def get_score_level(score: float) -> ScoreLevel:
    ...
    if score >= 90:
        ...
        return Sc<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1__generate_recommendation.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def _generate_recommendation(
  ...
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1__generate_risk_warning.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def _generate_risk_warning(dimensions: List[DimensionScore]) -> str:
    ...
    for dim in dimensions:
        if dim.level == ScoreLevel.LOW or dim.level == ScoreLevel.VERY_LOW:
            warnings.append(f"{dim.dimension}得分较低（{dim.total_score:.1f<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_adjust_weights_by_market_regime.py"
  language="python"
  showDesignPrinciples="true"
/>
...
def adjust_weights_by_market_regime(
    ...
    # 归一化权重
    total = sum(adjusted.values())<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_kb.py"
  language="python"
  showDesignPrinciples="true"
/>
...
results = mcp_client.call_tool(
    ...
    {
        "query"<CodeFromFile 
  filePath="code_library/004_Chapter4_Mainline_Identification/4.1/code_4_1_data_collector.py"
  language="python"
  showDesignPrinciples="true"
/>
...
> **适用版本**: v1.0.0+  
> **最后更新**: 2025-12-12
<!-- Code updated: 2025-12-14T02:27:21.546Z -->
