...
保存路径: code_library/002_Chapter2_Data_Source/2.3/code_2_3_save_to_parquet.py
...
def load_from_parquet(symbol: str, data_type: str = "daily") -> pd.Dat<CodeFromFile 
  filePath="code_library/002_Chapter2_Data_Source/2.3/002_Chapter2_Data_Source/2.3/code_2_3_save_to_hdf5.py"
  language="python"
