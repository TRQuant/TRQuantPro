...
保存路径: code_library/002_Chapter2_Data_Source/2.2/002_Chapter2_Data_Source/2.2/code_2_2_detect_anomalies_statistical.py
    ...
    **使用场景**：
    ...
    for field in fields:
        ...
        if len(anomalies) > 0:
            ...
            result["anomaly_indices"].update(anomaly_indices)
    
    result["anomaly_count"] = len(result["anomaly_indices"])
    return result