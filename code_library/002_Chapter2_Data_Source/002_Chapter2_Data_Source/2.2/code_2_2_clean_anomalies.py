...
保存路径: code_library/002_Chapter2_Data_Source/2.2/002_Chapter2_Data_Source/2.2/code_2_2_clean_anomalies.py
...
def clean_anomalies(self, data: pd.DataFrame,
    ...
    **使用场景**：
    ...
    if method == "remove":
        ...
        # 标记异常值（不删除）
        cleaned_data['_is_anomaly'] = False
        cleaned_data.loc[anomaly_indices, '_is_anomaly'] = True
