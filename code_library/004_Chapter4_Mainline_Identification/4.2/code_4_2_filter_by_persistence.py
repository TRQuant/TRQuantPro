"""
文件名: code_4_2_filter_by_persistence.py
保存路径: code_library/004_Chapter4_Mainline_Identification/4.2/code_4_2_filter_by_persistence.py
...
def filter_by_persistence(
    ...
    min_days: int = 5
        ...
        """
    filter_by_persistence函数
    
    **设计原理**：
    - **核心功能**：实现filter_by_persistence的核心逻辑
    - **设计思路**：通过XXX方式实现XXX功能
    - **性能考虑**：使用XXX方法提高效率
