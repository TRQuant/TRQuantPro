...
<CodeFromFile 
  filePath="code_library/008_Chapter8_Backtest/8.3/code_8_3_extract_nav_curve_from_bullettrade.py"
  language="python"
...
class TotalReturnAnalyzer:
  ...
  filePath="code_library/008_Chapter8_Backtest/8.3/code_8_3_usage_example.py"
  language="python"
  showDesignPrinciples="true"
/>
...
print(f"最大单日亏损: {result['max_daily_loss']:.<CodeFromFile 
...
print(f"信息比率: {result['informatio<CodeFromFile 
