...
research_results = {
    ...
    "testing": {
        "test_cases": [
            ...
            {"filename": "code.mmd", "result": "loaded"}
        ]
    }
}
```
...
<h2 id="section-10-11-3">🛠️ 10.11.3 工具链支持</h2>

工具链支持包括黑客助理、知识库检索、测试工具、文档工具等。

### 黑客助理（Data Collector Server）

**位置**：`mcp_servers/data_collector_server.py`
