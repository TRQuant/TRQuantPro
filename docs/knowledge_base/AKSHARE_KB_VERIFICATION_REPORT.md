...
```json
{
  "id": "kb_20260112_150420",
  "title": "AKShare股票数据: 历史行情数据-日线数据",
  "type": "reference",
  "tags": ["AKShare", "股票数据", "API文档", "历史数据", "日线数据"],
  "content": "...",
  "source": "https://akshare.akfamily.xyz/_sources/data/stock/stock.md.txt"
}
```
...
**脚本位置**: `scripts/kb/build_kb_akshare_from_source.py`
...
- 内容哈希: `docs/akshare_crawled/stock_data/content_hashes.json`

---

## 3. 在策略开发中使用知识库

### 3.1 场景：开发一个基于实时行情的选股策略
...
- **源文件**: `docs/akshare_crawled/stock_data/stock.md.txt`
- **使用文档**: `docs/knowledge_base/AKSHARE_KB_USAGE_EXAMPLE.md`
- **验证报告**: `docs/knowledge_base/AKSHARE_KB_VERIFICATION_REPORT.md` (本文档)
